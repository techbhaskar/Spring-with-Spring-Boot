...
public class EchoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			// Retrieve the value of the query parameter "username" (from text
			// field)
			String username = request.getParameter("username");
			// Get null if the parameter is missing from query string.
			// Get empty string or string of white spaces if user did not fill
			// in
			...
			// Retrieve the value of the query parameter "password" (from
			// password field)
			...
			// Retrieve the value of the query parameter "gender" (from radio
			// button)
			...
			// Retrieve the value of the query parameter "age" (from pull-down
			// menu)
			...
			// Retrieve the value of the query parameter "language" (from
			// checkboxes).
			...
			// Retrieve the value of the query parameter "instruction" (from
			// text area)
			...
			// Retrieve the value of the query parameter "secret" (from hidden
			// field)
			...
			out.println("<a href='forminput.html'>BACK</a>");
